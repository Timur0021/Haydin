	...
	<div class = 'button-row'>
	  ...
	  <div class = 'row add-post'>
	     <form action = 'posts.php' method = 'post'>
            <div class="col">
            <input type="text" class="form-control" placeholder="Title" aria-label="Назва статті">
            </div>
			...
			<div class="col">
            <label for="content" class="form-label">Вміст поста</label>
		...
		<div class="col">
        <button class="btn btn-primary" type="submit">Зберегти пост</button>
        </div>
		 </form>
	  </div>
	</div>
