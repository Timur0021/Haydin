...
<div class = 'container'>
   <div class = 'row'>
	...
	<div class = 'button-row'>
		<a href = 'users.php' name = 'button' type="button" class="col-2 btn btn-success"> Створити  </button></a>
	  ...
	  <div class = 'row title-table'>
	    <h2> Керування користувачами </h2>
		  ...
		  <div class = 'title col-5'> Ім'я користувача </div> 
		  <div class = 'author col-2'> Роль </div> 
		  <div class = 'red col-4'> Керування </div> 
	  </div>
	  <div class = 'row post'>
	      <div class = 'id col-1'> 1 </div>
		  <div class = 'title col-5'> Timur  </div> 
