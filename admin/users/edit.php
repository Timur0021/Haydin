...
<div class = 'container'>
   <?php include('../sidebar.php'); ?>
	...
	<div class = 'button-row'>
      ...
      <input name = "login" value = "<?=$username;?>" type="text" class="form-control" id="formGroupExampleInput" placeholder="Виведіть ваш логін...">
     </div>
   
     <div class="col">
       <label for="exampleInputEmail1" class="form-label">Email</label>
       <input name = "email" value = "<?=$email;?>" type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Виведіть ваш емейл...">
     </div>
    
     <div class="col">
      <label for="exampleInputPassword1" class="form-label">Змінити пароль</label>
	  ...
	  <input name="admin" class="form-check-input" value="1" type="checkbox" id="flexCheckChecked">
		...
		<div class="col">
        <button name="update-user" class="btn btn-primary" type="submit">Добавити пост</button>
        </div>
		 </form>
	  </div>
	</div>
